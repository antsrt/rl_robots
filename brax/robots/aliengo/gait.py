...
class AliengoGaitParams:
    period: jp.ndarray   # период походки (сек)
    r: jp.ndarray        # доля походки, проведенная в контакте с землей
    swing_h: jp.ndarray  # высота стопы над землей во время качания (м)
    dbody_h: jp.ndarray  # высота тела над землей, дельта от стандартной (м)
    bias: jp.ndarray     # смещение для каждой ноги; форма (4,)
